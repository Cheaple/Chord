...
var file_chord_chord_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0x89, 0x02, 0x0a, 0x05, 0x43, 0x68, 0x6f, 0x72, 0x64, 0x12, 0x1f, 0x0a, 0x06, 0x4c,
	...
	0x08, 0x2e, 0x42, 0x6f, 0x6f, 0x6c, 0x4d, 0x73, 0x67, 0x22, 0x00, 0x28, 0x01, 0x42, 0x09, 0x5a,
...
var file_chord_chord_proto_depIdxs = []int32{
	...
	1, // 8: Chord.Locate:output_type -> NodeEntry
	3, // 9: Chord.Check:output_type -> BoolMsg
	1, // 10: Chord.GetPredecessor:output_type -> NodeEntry
	2, // 11: Chord.GetSuccessorList:output_type -> NodeList
	3, // 12: Chord.SetPredecessor:output_type -> BoolMsg
	3, // 13: Chord.CheckKey:output_type -> BoolMsg
	3, // 14: Chord.UploadFile:output_type -> BoolMsg
