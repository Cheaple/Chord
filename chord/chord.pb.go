...
var file_chord_chord_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0xb1, 0x02, 0x0a, 0x05, 0x43, 0x68, 0x6f, 0x72, 0x64, 0x12, 0x1f, 0x0a, 0x06, 0x4c,
	...
	0x4d, 0x73, 0x67, 0x30, 0x01, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x63, 0x68, 0x6f, 0x72, 0x64,
...
var file_chord_chord_proto_depIdxs = []int32{
	...
	1, // 9: Chord.Locate:output_type -> NodeEntry
	3, // 10: Chord.Check:output_type -> BoolMsg
	1, // 11: Chord.GetPredecessor:output_type -> NodeEntry
	2, // 12: Chord.GetSuccessorList:output_type -> NodeList
	3, // 13: Chord.SetPredecessor:output_type -> BoolMsg
	3, // 14: Chord.CheckKey:output_type -> BoolMsg
	3, // 15: Chord.UploadFile:output_type -> BoolMsg
	6, // 16: Chord.DownloadFile:output_type -> FileMsg
